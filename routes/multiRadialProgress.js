...
const createImage = (req) => {
  ...
  for (let i in itemsList) {
    ...
    context.beginPath();
    context.arc(width / 2, height / 2, width / 3, startAngle, endAngle);
    context.stroke();
...
/* GET users listing. */
router.get('/multiRadialProgress.png', function (req, res, next) {
...
router.get('/multiRadialProgress.jpg', function (req, res, next) {
  let canvas = createImage(req);
